...
models = ['plot_16x16_ppo_image','plot_16x16_ppo_xy', 'plot_16x16_ppo_ssp-xy','plot_16x16_ppo_ssp-view',
          'plot_16x16_a2c_image','plot_16x16_a2c_xy', 'plot_16x16_a2c_ssp-xy',  'plot_16x16_a2c_ssp-view']
...
for i,model_name in enumerate(models):
    ...
    run(algo = algo, wrapper=input_type, model = model_name,dissim_coef=dissim_coef,#frames_per_proc=100,
          env=env_name, frames=30000, entropy_coef=entropy_coef, entropy_decay=entropy_decay, verbose=False)
